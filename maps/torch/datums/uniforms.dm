...
/decl/hierarchy/mil_uniform/SOLCOM
	name = "Master SOLCOM outfit"
	abstract_type = /decl/hierarchy/mil_uniform/SOLCOM
	branches = list(/datum/mil_branch/exoann)

	pt_under = /obj/item/clothing/under/solcom/pt
	pt_shoes = /obj/item/clothing/shoes/color/black

	utility_under = /obj/item/clothing/under/solcom/utility
	utility_shoes = /obj/item/clothing/shoes/jackboots/duty
	utility_hat = /obj/item/clothing/head/solcom/utility
	utility_extra = list(
		/obj/item/clothing/head/solcom/beret
	)
	service_under = /obj/item/clothing/under/solcom/service/uniform
	service_skirt = /obj/item/clothing/under/solcom/service/skirt
	service_over = /obj/item/clothing/suit/storage/solcom/service
	service_shoes = /obj/item/clothing/shoes/dress
	service_hat = /obj/item/clothing/head/solcom/garrison_cap

	dress_under = /obj/item/clothing/under/solcom/service/uniform
	dress_skirt = /obj/item/clothing/under/solcom/service/skirt
	dress_over = /obj/item/clothing/suit/solcom/dress
	dress_shoes = /obj/item/clothing/shoes/dress
	dress_hat = /obj/item/clothing/head/solcom/wheel_cap
