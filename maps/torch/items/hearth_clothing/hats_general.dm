/obj/item/clothing/head/beret/solcom/peacekeeper
	name = "peacekeeper beret"
	desc = "A beret in UN colors. For peacekeepers that are more inclined towards style than safety."
	color = COLOR_BABY_BLUE

/obj/item/clothing/head/beret/solcom/gateway
	name = "SOLCOM beret"
	desc = "An orange beret denoting service in one of the SOLCOM's many departments. For personnel that are more inclined towards style than safety."
	color = COLOR_ORANGE

/obj/item/clothing/head/beret/solcom/orbital
...
/obj/item/clothing/head/beret/solcom/research
...
/obj/item/clothing/head/beret/solcom/health
...
/obj/item/clothing/head/beret/solcom/diplomatic
