...
/obj/item/book/manual/sol_sop
	...
	desc = "SOP aboard the SCV Endeavor."
...
/obj/item/folder/envelope/captain
	desc = "A thick envelope. The SOLCOM crest is stamped in the corner, along with 'TOP SECRET - SOLCOM PROTOCOLS'."
...
/obj/item/folder/envelope/captain/LateInitialize()
	...
	<b>TO:</b> Commanding Officer of SCV Endeavor <br>
	...
	None of these systems are claimed by any entity recognized by the SOLCOM, so you have full salvage rights on any derelicts discovered.<br>
	Investigate and mark any prospective colony worlds as per usual procedures.<br>
	There is no SOLCOM presence in that area. In case of distress calls, you will be the only vessel available; our position in the eyes of the galaxy is tenuous at best.<br>
	...
	<i>ADM Lau.</i></tt>
	<i>This paper has been stamped with the stamp of SOLCOM National Council.</i>
	"}
	new/obj/item/paper(src, memo, "Standing Orders")
	new/obj/item/paper/umbra(src)

/obj/item/folder/envelope/rep
	desc = "A thick envelope. The SOLCOM crest is stamped in the corner, along with 'TOP SECRET - ENDEAVOUR PROTOCOLS'."
...
/obj/item/paper/umbra
	...
	<h3>OFFICE OF THE SECRETARY GENERAL OF THE SOLCOM NATIONAL COUNCIL</h3>
	<img src = 'SOLCOM.png'>
	</center>
	<b>FROM:</b> Johnathan Smitherson, Special Aide of the Secretary General<br>
	<b>TO:</b> Commanding Officer of the SCV Endeavor<br>
	<b>CC:</b> National Representative aboard the SCV Endeavor<br>
	...
	These procedures can be initiated only by transmission from SOLCOM Expeditionary Command via secure channel. The sender may not introduce themselves, but you shouldn't have trouble confirming the transmission source, I believe.<br>
	<br>
	...
	<li>HERA MOURNING: You may execute this protocol. In the event that the SCV Endeavor faces destruction in a manner which allows transmission of this protocol, you are to enact this protocol. Transmit all scientific and navigation data along with final crew roster.</li>

	<li>ICARUS DARKNESS: You may execute this protocol. In the event that the SCV Endeavor is at risk of capture by hostile alien forces, you are to ensure the destruction of the FTL drive and all sensitive navigational data, up to and including scuttling the ship via self-destruct if required.</li>
	...
	<li>HERMES EXPEDIENT: This protocol may only be enacted by Expeditionary Command. The SCV Endeavor is to immediately recall all deployed personnel and immediately set course for Sol under full communications blackout. Minimize resupply stops and prevent any crew from leaving the vessel. On entering the Sol system, park in Pluto orbit. You will be contacted.</li>

	<li>ARES RISING: In the event of an act of war, this protocol may only be enacted by Expeditionary Command and will contain a following identifier. The SCV Endeavor is to immediately escalate to blue alert and actively avoid all entities associated with the given identifier, and any members of the identifier's species or faction are to be arrested immediately. The SCV Endeavor is to wrap up current exploration operations and recall to Sol if no threat is present.</li>

	<li>APOLLYON ASCENDANT: In the event of a end-of-humanity scenario - genocidal invasion, all-out-interstellar war, xenolife infestation, or other event that will meaningfully reduce the human population by a significant degree, this protocol will be enacted by command. The SCV Endeavor is to set course for the nearest known allied system and make port until contacted by the system's controlling government. In the event that this is not possible, the SCV Endeavor is to locate the nearest habitable planet and remain in orbit, conducting expeditions to assess suitability for a new colony. </li>
